...
const UserAdd: React.FC<UserAddProps> = ({ navigation, route }) => {
    ...
    const passedRole: string = route.params.role;
    ...
    const title =
        action === ACTION.SIGNUP
            ? "Sign Up"
            : `Add ${passedRole[0].toUpperCase() + passedRole.slice(1)}`;
    ...
    const handleSignup = async () => {
        ...
        await axios
            .post(`${SignUpURI}/${passedRole}`, user)
            .then((_: any) => {
    ...
    return (
        ...
        >
            ...
            >
                <Text>{passedRole[0].toUpperCase() + passedRole.slice(1)} Added</Text>
                <View
                    style={{
                        flexDirection: "row",
