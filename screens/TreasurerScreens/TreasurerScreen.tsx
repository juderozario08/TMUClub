...
const TreasurerScreen = () => {
	...
	return isLoading() ? (
		...
		<BottomTab.Navigator
			initialRouteName={"Dashboard" as keyof BottomTabParamList}
		...
		>
			<BottomTab.Screen
				name={"Dashboard" as keyof BottomTabParamList}
				initialParams={{
					user: user,
			...
			/>
			<BottomTab.Screen
				name={"Classes" as keyof BottomTabParamList}
			...
			/>
			<BottomTab.Screen
				name={"User Management" as keyof BottomTabParamList}
			...
			/>
			<BottomTab.Screen
				name={"Profile" as keyof BottomTabParamList}
				component={Profile}
				options={() => ({
					tabBarIcon: ({ focused }) => {
						const col = focused ? tabColor : "darkgray";
